...
export const OFFLINE_LIBRARY: LibraryEntry[] = [
    ...
    {
        id: '1J59', title: 'CATABOLITE GENE ACTIVATOR PROTEIN (CAP)/DNA COMPLEX + ADENOSINE-3\',5\'-CYCLIC-MONOPHOSPHATE',5\'-CYCLIC-MONOPHOSPHATE', 5\'-CYCLIC-MONOPHOSPHATE', 5\'-CYCLIC-MONOPHOSPHATE', 5\'-CYCLIC-MONOPHOSPHATE', category: 'Transport', description: 'Water channel.', details: 'The plumbing of the cell. Aquaporins conduct billions of water molecules per second while strictly filtering out protons and other ions.',
        method: 'X-RAY DIFFRACTION',
        resolution: '2.5 Å',
        organism: 'Escherichia coli',
    ...
    {
        id: '3H5B', title: 'Crystal structure of wild type HIV-1 protease with novel P1\'-ligand GRL-02031'-ligand GRL-02031' - ligand GRL- 02031'-ligand GRL-02031' - ligand GRL-02031', category: 'Viral', description: 'Tamiflu target.', details: 'The "N" in H1N1.This influenza enzyme helps the virus detach from cells.It is the target of the drug Tamiflu(Oseltamivir).',
        method: 'X-RAY DIFFRACTION',
    resolution: '1.29 Å',
    organism: 'Human immunodeficiency virus type 1 (BRU ISOLATE)',
...
{
    id: '5O3L', title: 'Paired helical filament in Alzheimer\'s disease brain's disease brain's disease brain's disease brain's disease brain', category: 'Enzymes', description: 'Immortality enzyme.', details: 'The enzyme that rebuilds chromosome ends(telomeres).It allows cancer cells to divide indefinitely.',
    method: 'ELECTRON MICROSCOPY',
        resolution: '3.4 Å',
            organism: 'Homo sapiens',
...
{
    id: '1J3F', title: 'Crystal Structure of an Artificial Metalloprotein:Cr(III)(3,3\'-Me2-salophen)/apo-A71G Myoglobin'-Me2-salophen)/apo-A71G Myoglobin'-Me2-salophen)/apo-A71G Myoglobin' - Me2 - salophen) /apo-A71G Myoglobin'-Me2-salophen)/apo - A71G Myoglobin'-Me2-salophen)/apo-A71G Myoglobin' - Me2 - salophen) /apo-A71G Myoglobin'-Me2-salophen)/apo - A71G Myoglobin'-Me2-salophen)/apo-A71G Myoglobin', category: 'Enzymes', description: 'Firefly glow.', details: 'The enzyme that produces light in fireflies by oxidizing luciferin. It is used as a reporter gene in biological research.',
        method: 'X-RAY DIFFRACTION',
            resolution: '1.45 Å',
                organism: 'Physeter catodon',
...
{
    id: '1Q1G', title: 'Crystal structure of Plasmodium falciparum PNP with 5\'-methylthio-immucillin-H'-methylthio-immucillin-H' - methylthio - immucillin - H'-methylthio-immucillin-H' - methylthio - immucillin - H', category: 'Synthetic', description: 'De novo design.', details: 'One of the earliest successes in computational protein design, creating a stable chemical building block not found in nature.',
    method: 'X-RAY DIFFRACTION',
        resolution: '2.02 Å',
...
{
    id: '6NKA', title: 'Crystal structure of Mycobacterium tuberculosis dethiobiotin synthetase in complex with 2\'-deoxycytidine'-deoxycytidine' - deoxycytidine'-deoxycytidine' - deoxycytidine', category: 'Viral', description: 'Ebola Nucleoprotein.', details: 'The protein that wraps and protects the Ebola virus RNA genome.',
    method: 'X-RAY DIFFRACTION',
        resolution: '2.23 Å',
