...
export const OFFLINE_LIBRARY: LibraryEntry[] = [
    ...
    // MEMBRANE PROTEINS
    { id: '1BL8', title: 'KcsA Potassium Channel', category: 'Transport', description: 'Ion channel.', details: 'The KcsA channel reveals nature\',
        method: 'X-RAY DIFFRACTION',
        resolution: '3.2 Å',
        organism: 'Streptomyces lividans',
        depositionDate: '1998-07-23's secret to ion selectivity. It allows potassium ions to pass at close to diffusion limits while blocking smaller sodium ions using a precise geometry of carbonyl oxygens.' },
    ...
    { id: '6Q40', title: 'Parkin', category: 'Enzymes', description: 'Associated with Parkinsons.', details: 'Parkin is an E3 ubiquitin ligase that tags damaged mitochondria for destruction. Mutations in this gene disrupt cellular quality control and are a cause of familial Parkinson\',
        method: 'X-RAY DIFFRACTION',
        resolution: '2.412 Å',
        organism: 'Zymoseptoria tritici IPO323',
        depositionDate: '2018-12-05's disease.' },
    ...
    { id: '1AON', title: 'GroEL/GroES', category: 'Chaperone', description: 'Protein folding machine.', details: 'This massive chaperonin complex acts as a "protein folding machine". It provides a protected central cavity where unfolded proteins can safely fold in isolation, preventing aggregation.',
        method: 'X-RAY DIFFRACTION',
        resolution: '3 Å',
        organism: 'Escherichia coli',
    ...
    { id: '1Y12', title: 'Yeast Prion', category: 'Structural', description: 'Amyloid.', details: 'A protein that can switch to an infectious, self-propagating shape. It offers insight into diseases like Mad Cow and Alzheimer\',
        method: 'X-RAY DIFFRACTION',
        resolution: '1.95 Å',
        organism: 'Pseudomonas aeruginosa PAO1',
        depositionDate: '2004-11-16's.' },
    ...
    { id: '2B4C', title: 'Cytochrome c', category: 'Energy', description: 'Electron transport.', details: 'A small heme protein loosely associated with the inner mitochondrial membrane. It shuttles electrons but also triggers apoptosis if released into the cell.',
        method: 'X-RAY DIFFRACTION',
        resolution: '3.3 Å',
    ...
    { id: '1JFF', title: 'Tubulin', category: 'Structural', description: 'Microtubule subunit.', details: 'The building block of microtubules (the cell\',
        method: 'ELECTRON CRYSTALLOGRAPHY',
        resolution: '3.5 Å',
        organism: 'Bos taurus',
        depositionDate: '2001-06-20's highways). It is the target of Taxol, a chemotherapy drug that freezes cell division.' },
    ...
    { id: '1E6E', title: 'Acetylcholinesterase', category: 'Enzymes', description: 'Neurotransmitter breakdown.', details: 'One of nature\',
        method: 'X-RAY DIFFRACTION',
        resolution: '2.3 Å',
        organism: 'BOS TAURUS',
        depositionDate: '2000-08-15's fastest enzymes. It cleans up acetylcholine at the synapse to stop nerve signaling. Nerve agents like Sarin work by irreversibly blocking this enzyme.' },
    ...
    { id: '1E8O', title: 'Cytochrome P450', category: 'Enzymes', description: 'Detoxification.', details: 'The body\',
        method: 'X-RAY DIFFRACTION',
        resolution: '3.2 Å',
        organism: 'HOMO SAPIENS',
        depositionDate: '2000-09-28's primary detox enzyme. It oxidizes steroids, fatty acids, and xenobiotics (drugs/toxins) to make them water-soluble.' },
    ...
    { id: '1Q01', title: 'Heat Shock Protein 90', category: 'Chaperone', description: 'Stress response.', details: 'A molecular chaperone that stabilizes proteins under stress. It is a target for cancer therapy due to its role in stabilizing oncogenes.',
        method: 'SOLUTION NMR',
        resolution: 'N/A',
    ...
    { id: '2K2C', title: 'Amyloid Beta', category: 'Structural', description: 'Alzheimer\'s fibril.', details: 'A solid-state NMR structure of the amyloid fibril found in Alzheimer\',
        method: 'SOLUTION NMR',
        resolution: 'N/A',
        organism: 'Homo sapiens',
        depositionDate: '2008-03-31's plaques. It shows the cross-beta sheet architecture.' },
    ...
    { id: '1HYS', title: 'HIV Reverse Transcriptase', category: 'Viral', description: 'Viral replication.', details: 'The target of AZT. This enzyme copies the viral RNA genome into DNA, which then integrates into the host cell\',
        method: 'X-RAY DIFFRACTION',
        resolution: '3 Å',
        organism: 'Human immunodeficiency virus 1',
        depositionDate: '2001-01-22's genome.' },
    ...
    { id: '4COF', title: 'GABA-A Receptor', category: 'Signaling', description: 'Sedation target.', details: 'The brain\',
        method: 'X-RAY DIFFRACTION',
        resolution: '2.97 Å',
        organism: 'HOMO SAPIENS',
        depositionDate: '2014-01-28's main inhibitory channel. It is the target of benzodiazepines (Valium) and anesthetics.' },
    ...
    { id: '3POW', title: 'Calreticulin', category: 'Chaperone', description: 'ER Chaperone.', details: 'A key chaperone in the Endoplasmic Reticulum that binds calcium. It ensures proper folding of glycoproteins and is part of the immune system\',
        method: 'X-RAY DIFFRACTION',
        resolution: '1.55 Å',
        organism: 'Homo sapiens',
        depositionDate: '2010-11-23's "eat me" signal.' },
