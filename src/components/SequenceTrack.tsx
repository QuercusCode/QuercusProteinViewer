...
export const SequenceTrack: React.FC<SequenceTrackProps> = ({
    ...
    return (
        <div id={id} className={`hidden md:flex relative h-full w-24 rounded-none shrink-0 z-10 border-l
            ...
            <div className={`flex flex-col items-center pt-24 pb-2 gap-2 border-b ${isLightMode ? 'border-neutral-200 bg-white/50' : 'border-neutral-800 bg-black/50'} z-10 flex-shrink-0 backdrop-blur-md`}>
